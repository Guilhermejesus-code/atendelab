...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        ...
        <div class="d-flex flex-wrap gap-2">
            <a class="btn btn-success" href="?controller=frontend&action=pessoas">
                Gerenciar pessoas
            </a>
            <a class="btn btn-outline-success" href="?controller=frontend&action=tipos">
                Gerenciar tipos
            </a>
            <a class="btn btn-outline-success" href="?controller=frontend&action=atendimentos">
