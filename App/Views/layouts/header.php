        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menuPrincipal">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="?controller=auth&action=dashboard">
                            Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?controller=frontend&action=pessoas">
                            Pessoas
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?controller=frontend&action=tipos">
                            Tipos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?controller=frontend&action=atendimentos">
                            Atendimentos
                        </a>
                    </li>
                </ul>
